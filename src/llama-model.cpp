...
struct llm_build_mamba : public llm_graph_context {
    ...
    static ggml_tensor * build_mamba_layer(
        ...
        ggml_tensor * conv = self->build_rs(inp, gf, conv_states_all, self->hparams.n_embd_k_s(), n_seqs);
        ...
        // ssm
        {
            ...
            ggml_tensor * y_ssm = self->build_rs(inp, gf, ssm_states_all, self->hparams.n_embd_v_s(), ubatch.n_seqs, get_ssm_rows);
