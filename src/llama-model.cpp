    ...
    virtual ggml_tensor * build_mamba_layer(
      ...
      const llama_ubatch & ubatch,
        ...
        ggml_tensor * ssm = build_rs(
                ...
                hparams.n_embd_v_s(), n_seqs, true);
        ...
        // ssm
        {
            ...
            struct ggml_tensor * ssm_ids = ggml_view_1d(ctx0, state_copy, n_seqs, 0);
            ...
            struct ggml_tensor * y = ggml_view_3d(ctx0, y_ssm, d_inner, n_seq_tokens, n_seqs, x->nb[2], x->nb[3], 0);
...
struct llm_build_mamba2 : public llm_build_mamba {
    ...
    const llama_ubatch & ubatch,
        ...
        // ssm
        {
            ...
            struct ggml_tensor * y = ggml_view_4d(ctx0, y_ssm, head_dim, n_head, n_seq_tokens, n_seqs, x->nb[1], n_head*x->nb[1], n_seq_tokens*n_head*x->nb[1], 0);
