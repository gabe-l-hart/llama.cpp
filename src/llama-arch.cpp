...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_CTC_CONFORMER,    "ctc-conformer"    },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_CTC_CONTEXT_SIZE,          "%s.ctc.context_size"     },
    { LLM_KV_CTC_MAX_POS_EMB,           "%s.ctc.max_pos_emb"      },
    { LLM_KV_CTC_CONV_KERNEL,           "%s.ctc.conv_kernel"      },
    { LLM_KV_CTC_SUBSAMPLE_LAYERS,      "%s.ctc.subsample_layers" },
    { LLM_KV_CTC_CONV_EXPANSION_FACTOR, "%s.ctc.conv_expansion_factor" },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_REL_POS,                           "blk.%d.attn_rel_pos" },
    { LLM_TENSOR_CONV_NORM,                              "blk.%d.conv_norm" },
    { LLM_TENSOR_CONV_PW1,                               "blk.%d.conv_pw1" },
    { LLM_TENSOR_CONV_PW2,                               "blk.%d.conv_pw2" },
    { LLM_TENSOR_CONV_DW,                                "blk.%d.conv_dw" },
    { LLM_TENSOR_CONV_DW_NORM,                           "blk.%d.conv_dw_norm" },
    { LLM_TENSOR_FFN_NORM_1,                             "blk.%d.ffn_norm_1" },
    { LLM_TENSOR_FFN_UP_1,                               "blk.%d.ffn_up_1" },
    { LLM_TENSOR_FFN_DOWN_1,                             "blk.%d.ffn_down_1" },
    { LLM_TENSOR_CTC_OUT_MID,                            "ctc_out_mid" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_REL_POS,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_GET_ROWS}},
    {LLM_TENSOR_CONV_NORM,                  {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_CONV_PW1,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_CONV_PW2,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_CONV_DW,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_SSM_CONV}},
    {LLM_TENSOR_CONV_DW_NORM,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_NORM_1,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_FFN_UP_1,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_FFN_DOWN_1,                 {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_CTC_OUT_MID,                {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
