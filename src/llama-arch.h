...
enum llm_kv {
    ...
    LLM_KV_ADAPTER_RANKS,
    LLM_KV_MAX_LORA_RANK,
    LLM_KV_ADAPTER_TOKEN_IDS,
    LLM_KV_ADAPTER_SUBSTITUTE_TOKEN_IDS,
    LLM_KV_CONTROL_TOKEN_GAIN,
    LLM_KV_SWITCH_HEAD_DIM,
    LLM_KV_PROJECTION_HEAD_DIM,
    LLM_KV_LORA_TARGET_MODULES,
