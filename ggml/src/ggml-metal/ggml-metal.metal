...
kernel void kernel_ssm_scan_f32(
    ...
    const uint64_t nb02 = args.nb02;
    const uint64_t nb03 = args.nb03;
    const uint64_t nb11 = args.nb11;
    const uint64_t nb12 = args.nb12;
    const uint64_t nb13 = args.nb13;
    const uint64_t nb21 = args.nb21;
    const uint64_t nb22 = args.nb22;
    const uint64_t nb31 = args.nb31;
    const uint64_t nb41 = args.nb41;
    const uint64_t nb42 = args.nb42;
    const uint64_t nb43 = args.nb43;
    const uint64_t nb51 = args.nb51;
    const uint64_t nb52 = args.nb52;
    const uint64_t nb53 = args.nb53;

    const int64_t s_off = nr * nh * n_t * n_s * sizeof(float);
