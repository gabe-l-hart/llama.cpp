...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.OUTPUT: (
            ...
            "encoder.out",               # granite_speech_ctc (also reused mid-stack for self-conditioning)
        ),
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "encoder.layers.{bid}.attn.pre_norm",                   # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.ATTN_Q: (
            ...
            "encoder.layers.{bid}.attn.to_q",                            # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.ATTN_K: (
            ...
            "encoder.layers.{bid}.attn.to_k",                          # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.ATTN_V: (
            ...
            "encoder.layers.{bid}.attn.to_v",                            # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "encoder.layers.{bid}.attn.to_out",                             # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "encoder.layers.{bid}.ff1.pre_norm",                             # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.FFN_POST_NORM: (
            ...
            "encoder.layers.{bid}.post_norm",                 # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "encoder.layers.{bid}.ff1.up_proj",                       # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "encoder.layers.{bid}.ff1.down_proj",                     # granite_speech_ctc
        ),
        ...
        MODEL_TENSOR.FFN_UP_1: (
            "encoder.layers.{bid}.ff2.up_proj",
        ),
